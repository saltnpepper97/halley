...
impl Halley {
    pub(crate) fn set_fullscreen_direct_scanout_status(
        &mut self,
        monitor: &str,
        ...
        self.model.fullscreen_state.direct_scanout.insert(
            monitor.to_string(),
    ...
    pub(crate) fn clear_fullscreen_direct_scanout_for_monitor(&mut self, monitor: &str) {
        self.model.fullscreen_state.direct_scanout.remove(monitor);
    }

    pub(crate) fn clear_fullscreen_direct_scanout_for_node(&mut self, node_id: NodeId) {
        self.model
            .fullscreen_state
            .direct_scanout
            .retain(|_, state| {
